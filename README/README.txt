...
(xbench-style deterministic QA with 31 checks across 5 groups — 30
active by default, plus 1 opt-in confusable-pairs check) for validating
...
The QA tab runs 31 checks across 5 groups (Content, Terminology,
Tags, Numeric Elements, Spelling). 30 are active by default; the
31st (confusable_pairs —
real-word spelling traps that spell-check can't catch) ships opt-IN.

...
# replaced the HTML report's "Sort by severity" toggle with "Sort by tags"
...
# Task #68 — primary sort key for the HTML "Sort by tags" toggle. Order
...
# insertion order so the in-group ordering inside the HTML "Sort by tags"

...
def _qa_highlight(text: str, span=None, category_id: str = None) -> str:
    ...
    # with each space (ASCII U+0020 *or* a non-breaking space U+00A0)
    # swapped for a middle dot `·` so the reviewer sees exactly where (and
    # how many) extra spaces live in the target.
